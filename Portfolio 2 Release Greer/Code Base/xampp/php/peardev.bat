...
FOR %%x IN ("C:\Users\newvo\DesktopC:\Users\Michael\Desktop\xampp\php\PEAR") DO (if %%x=="%PMTPMTPMT%" GOTO :NOTINSTALLED)

REM Check PEAR global ENV, set them if they do not exist
IF "%PHP_PEAR_INSTALL_DIR%"=="" SET "PHP_PEAR_INSTALL_DIR=C:\Users\newvo\DesktopC:\Users\Michael\Desktop\xampp\php\PEAR"
IF "%PHP_PEAR_BIN_DIR%"=="" SET "PHP_PEAR_BIN_DIR=C:\Users\newvo\DesktopC:\Users\Michael\Desktop\xampp\php"
IF "%PHP_PEAR_PHP_BIN%"=="" SET "PHP_PEAR_PHP_BIN=C:\Users\newvo\DesktopC:\Users\Michael\Desktop\xampp\php\php.exe"
GOTO :INSTALLED
