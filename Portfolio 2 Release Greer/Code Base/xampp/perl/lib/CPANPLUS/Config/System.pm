...
sub setup {
    ...
    $conf->set_conf( base => 'C:\\Users\\newvo\\DesktopC:\\Users\\Michael\\Desktop\\xampp\\perl\\bin\\.cpanplus' );    
    ...
    $conf->set_program( perlwrapper => 'C:\\Users\\newvo\\DesktopC:\\Users\\Michael\\Desktop\\xampp\\perl\\bin\\cpanp-run-perl.bat' );    
